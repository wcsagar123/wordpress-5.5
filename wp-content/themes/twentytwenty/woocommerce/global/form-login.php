    ...
    <div class="spe-res">
      <div class="datepicker">
        <fieldset class="form-group">
          ...
          <label for="username"><?php esc_html_e( 'Votre adresse e-mail', 'woocommerce' ); ?>&nbsp;<span class="required">*</span></label>
		
        </fieldset>
        <fieldset class="form-group">
          
          <input  type="password" name="password" id="password" autocomplete="current-password" />
          <label for="password"><?php esc_html_e( 'Choisissez un mot de passe', 'woocommerce' ); ?>&nbsp;<span class="required">*</span></label>
