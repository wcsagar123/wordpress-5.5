      ...
      <div class="row">
        ...
        <form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
						...
						if ( $_product->is_sold_individually() ) {
							...
							$product_quantity = woocommerce_quantity_input(
								array(
									...
									'max_value'    => 9,//$_product->get_max_purchase_quantity(),
									'min_value'    => '0',
          ...
          <?php if($product_id == 753 || $product_id == 1884 || $product_id == 1004 || $product_id == 1626  ){              ?>
            <label class="checkbox m-0 text-left pl-0">Reprise de votre ancien sommier </label>
              <?php
            }else{
             ?>
            <label class="checkbox m-0 text-left pl-0">Reprise de votre ancien matelas </label>
            <?php
            }
            ?>
