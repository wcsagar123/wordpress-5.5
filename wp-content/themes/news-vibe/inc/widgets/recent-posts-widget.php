...
if ( ! class_exists( 'news_vibe_Recent_Post' ) ) :

     
    class News_Vibe_Recent_Post extends WP_Widget {
        /**
        ...
        public function __construct() {
            $tp_widget_recent_post = array(
                ...
                'description' => esc_html__( 'Retrive recent posts.', 'news-vibe' ),
            );
            parent::__construct( 'mega_blog_pro_recent_post', esc_html__( 'TP : Recent Posts', 'news-vibe' ), $tp_widget_recent_post );
        }
        ...
        public function widget( $args, $instance ) {
            ...
            echo '<ul>';
            $wp_query = get_posts( $recent_args );
            	$count = 1;
        ...
        public function form( $instance ) {
            $tp_title      = isset( $instance['title'] ) ? ( $instance['title'] ) : esc_html__( 'Recent Posts', 'news-vibe' );
            $tp_number     = isset( $instance['number'] ) ? absint( $instance['number'] ) : 3;
            $tp_category   = isset( $instance['category'] ) ? absint( $instance['category'] ) : '';
           ?>
