...
class News_Vibe_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'news_vibe';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'news-vibe' ), $i ),
...
// Initialize.
$news_vibe_footer_widgets = new News_Vibe_Footer_Widgets();
